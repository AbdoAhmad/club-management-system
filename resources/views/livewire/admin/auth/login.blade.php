    <div class="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-10 card-container" style="animation-delay: 0s;">
                <div
                    class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-yellow-500 to-yellow-700 rounded-2xl mb-6 shadow-lg">
            ...
            <div wire:submit.prevent="login" class="glass-card p-8 card-container" style="animation-delay: 0.1s;">
                ...
                <form id="loginForm" class="space-y-4">
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="email" type="email" class="w-full input-field"
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="password" type="password" class="w-full input-field" placeholder="••••••••"
                            required>
                    </div>
                    @error('password')
                        <p class="text-red-500">{{ $message }}</p>
                ...
                <div class="grid grid-cols-3 gap-3 btn-container" style="animation-delay: 0.45s;">
                    <button type="button" class="btn-social flex justify-center items-center h-12">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm3 12h-3v3h-2v-3h-3v-2h3v-3h2v3h3v2z" />
                        </svg>
                    </button>
                    <button type="button" class="btn-social flex justify-center items-center h-12">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <button type="button" class="btn-social flex justify-center items-center h-12">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M23.953 4.57a10 10 0 002.856-3.915 10.019 10.019 0 01-2.836.856 4.958 4.958 0 002.165-2.724c-.951.564-2.005.974-3.127 1.195a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                        </svg>
                    </button>
                </div>
                ...
                <p class="text-center text-gray-300 text-sm mt-8"
                    style="animation: slideInUp 0.8s cubic-bezier(0.4, 0, 0.2, 1) 0.5s both;">
                    Don't have an account?
                    <a href='{{ route('admin.register') }}' class="text-link">Create one now</a>
                </p>
            </div>
