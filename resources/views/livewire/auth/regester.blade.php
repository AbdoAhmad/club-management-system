 <div class="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        ...
        <div class="w-full max-w-md">
            ...
            <!-- Glass Card Form -->
            <div class="glass-card p-8 card-container" style="animation-delay: 0.1s; max-height: 90vh; overflow-y-auto;">
                <h2 class="text-2xl font-bold text-white mb-6 text-center">Create Account</h2>

                <form wire:submit.prevent="register" id="registerForm" class="space-y-3">
                    <!-- Avatar Upload -->
                    <div class="avatar-container">
                        <label for="avatar-input" class="avatar-circle">
                            ...
                            <span>Add Photo</span>
                            <img id="avatar-preview" class="avatar-preview-img" src="#" alt="Preview">
                        </label>
                        <input type="file" id="avatar-input" class="hidden" accept="image/*" onchange="previewImage(this)">
                    </div>
                    ...
                    <div class="form-group mt-5">
                        <label class="flex items-start cursor-pointer">
                            <input type="checkbox" class="checkbox-input mt-1" required>
                ...
                <!-- Sign In Link -->
                <p class="text-center text-gray-300 text-sm mt-6" style="animation: slideInUp 0.8s cubic-bezier(0.4, 0, 0.2, 1) 0.4s both;">
